...
def ClusteringLinkage(data_frame):
    ...
    cluster_return = pd.DataFrame(data = cluster_linkage[1:,1:],    # values
                                  index = cluster_linkage[1:,0],    # 1st column as index
                                  columns = cluster_linkage[0,1:])  # 1st row as the column names
...
def ClusteringSingle(data_frame):
    ...
    cluster_return = pd.DataFrame(data = cluster_single[1:,1:],    # values
                                  index = cluster_single[1:,0],    # 1st column as index
                                  columns = cluster_single[0,1:])  # 1st row as the column names
    return cluster_return
...
def ClusteringWeighted(data_frame):
    ...
    cluster_return = pd.DataFrame(data = cluster_weighted[1:,1:],    # values
                                  index = cluster_weighted[1:,0],    # 1st column as index
                                  columns = cluster_weighted[0,1:])  # 1st row as the column names
    return cluster_return
...
def ClusteringCentroid(data_frame):
    ...
    cluster_return = pd.DataFrame(data = cluster_centroid[1:,1:],    # values
                                  index = cluster_centroid[1:,0],    # 1st column as index
                                  columns = cluster_centroid[0,1:])  # 1st row as the column names
    return cluster_return
...
def ClusteringAverage(data_frame):
    ...
    cluster_return = pd.DataFrame(data = cluster_average[1:,1:],    # values
                                  index = cluster_average[1:,0],    # 1st column as index
                                  columns = cluster_average[0,1:])  # 1st row as the column names
    return cluster_return